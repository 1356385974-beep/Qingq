...
export function UserMenu() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#00b4ff] to-[#7b61ff] flex items-center justify-center text-white font-bold shadow-lg">
          用
        </div>
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-5 border-b border-[#f0f2f5]/50">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#00b4ff] to-[#7b61ff] flex items-center justify-center text-white font-bold text-xl shadow-lg">
                  用
                </div>
                <div>
