                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {transcript.aiGenerated && (
                      <span className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium ${
                        theme === 'dark'
                          ? 'bg-gradient-to-r from-[#00b4ff40] to-[#7b61ff40] text-[#a5b4fc]'
                          : 'bg-gradient-to-r from-[#00b4ff25] to-[#7b61ff25] text-[#7b61ff]'
                      }`}>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {transcript.keyDecisions.slice(0, 3).map((decision, i) => (
                      <span key={i} className={`px-2.5 py-1 rounded-full text-xs ${
                        theme === 'dark'
                          ? 'bg-[#00b42a30] text-[#00e639]'
                          : 'bg-[#00b42a25] text-[#00b42a]'
                      }`}>
