      ...
      <AnimatePresence>
        {showAddModal && (
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-[#1d2129]'}`}>新建待办事项</h2>
                <button
                  onClick={() => setShowAddModal(false)}
                  className={`p-2 rounded-xl transition-all ${
                    theme === 'dark'
              ...
              <div className="space-y-5">
                <div>
                  <label className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-white/80' : 'text-[#1d2129]'}`}>标题 *</label>
                  <input
                    type="text"
                    value={newTodo.title}
                ...
                <div>
                  <label className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-white/80' : 'text-[#1d2129]'}`}>描述</label>
                  <textarea
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-white/80' : 'text-[#1d2129]'}`}>截止日期</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-white/80' : 'text-[#1d2129]'}`}>优先级</label>
                    <select
                ...
                <div>
                  <label className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-white/80' : 'text-[#1d2129]'}`}>标签</label>
                  <div className="flex flex-wrap gap-2 mb-3">
                    {newTodo.tags?.map((tag) => (
                      <span key={tag} className={`px-3 py-1.5 rounded-full text-sm flex items-center gap-2 ${
                        theme === 'dark'
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="添加标签..."
                      className={`flex-1 px-4 py-2.5 rounded-xl border focus:border-[#00b4ff] focus:ring-4 focus:ring-[#00b4ff10] transition-all outline-none text-sm ${
                        theme === 'dark'
                          ? 'bg-white/10 border-white/20 text-white placeholder-white/40'
                          : 'border-[#f0f2f5]'
                      }`}
